...
MEDIA_TRANSLATIONS = [
    ...
    # The Bad Batch
    (r'Aftermath \(episódio\)', 'Depois do Fim'),
    (r'"Marcas da Guerra"', '"Depois do Fim"'),
    (r'\bCut and Run\b', 'Saída às Pressas'),
    (r'\bReplacements\b', 'Substitutos'),
    (r'\bCornered\b', 'Encurralados'),
    (r'\bRampage \(episódio\)', 'Tumulto'),
    (r'\bDecommissioned\b', 'Desmontagem'),
    (r'\bBattle Scars\b', 'Cicatrizes de Batalha'),
    (r'\bReunion\b', 'Reunião'),
    (r'\bBounty Lost\b', 'Recompensa Perdida'),
    (r'\bCommon Ground\b', 'Ponto em Comum'),
    (r'\bDevil\'s Deal\b', 'Acordo com o Inimigo'),
    (r'\bRescue on Ryloth \(episódio\)', 'Resgate em Ryloth'),
    (r'\bDevil\'s Deal\b', 'Acordo com o Inimigo'),
    (r'\bInfested\b', 'Infestação'),
    (r'\bWar-Mantle\b', 'Manto de Guerra'),
    (r'\bReturn to Kamino\b', 'Retorno a Kamino'),
    (r'\bKamino Lost\b', 'Kamino Perdido'),
    (r'\bSpoils of War\b', 'Sobras da Guerra'),
    (r'\bRuins of War\b', 'Marcas da Guerra (episódio)'),
    (r'\bThe Solitary Clone\b', 'O Clone Solitário'),
    (r'\bFaster\b', 'Acelera'),
    (r'\bEntombed\b', 'Sepultado'),
    (r'\bTribe\b', 'Tribo'),
    (r'\bThe Clone Conspiracy\b', 'A Conspiração dos Clones'),
    (r'\bTruth and Consequences\b', 'Verdade e Consequências'),
    (r'\bThe Crossing\b', 'A Travessia'),
    (r'\bRetrieval \(episódio\)', 'Recuperação'),
    (r'\bMetamorphosis \(episódio\)', 'Metamorfose'),
    (r'\bThe Outpost\b', 'O Posto Avançado'),
    (r'\bTipping Point\b', 'Momento Decisivo'),
    (r'\bThe Summit\b', 'A Conferência'),
    (r'\bPlan 99\b', 'Plano 99'),
    (r'\bConfined\b', 'Confinada'),
    (r'\bPaths Unknown\b', 'Caminhos Desconhecidos'),
    
    (r'\bFamily Reunião – and Farewell\b', 'Family Reunion – and Farewell'),
    (r'\bJedi: Cicatrizes de Batalha\b', 'Jedi: Battle Scars'),
